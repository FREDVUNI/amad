    ...
    class User extends CI_Controller{
            ...
            $data['title'] ="Profile";
             ...
             if($this->form_validation->run() == false):
                ...
                $this->session->set_flashdata('message', '<div class="alert alert-success role="alert">
                        <Span class="fas fa-check-circle"></span>   Your profile has been updated.</div>');
        ...
        public function register(){
            ...
            $this->_sendEmail($token,'verify');
                $this->session->set_flashdata('message','<div class="alert alert-success" role="alert">
                <Span class="fas fa-check-circle"></span> The user has been saved.</div>');
        ...
        public function changePassword(){
            ...
            if($this->form_validation->run() == false):
                $this->load->view('templates/backend/header',$data);
                $this->load->view('templates/backend/sidebar');
                $this->load->view('backend/users/changepassword',$data);
                ...
                if(! password_verify($current,$data['user']['password'])):
                    ...
                    <Span class="fas fa-times-circle"></span> The current password is wrong.</div>');
                    redirect('admin/changepassword');
                else:
                    if($current == $new):
                        $this->session->set_flashdata('message','<div class="alert alert-danger" role="alert">
                        <Span class="fas fa-times-circle"></span> The new password cannot be the same as the current password.</div>');
                        redirect('admin/changepassword');
                    else:
                        ...
                        $this->session->set_flashdata('message','<div class="alert alert-success" role="alert">
                        <Span class="fas fa-check-circle"></span> Your Password Has Been Changed Successfully.</div>');
                        redirect('admin/changepassword');
                    endif;
                endif;
            endif;
        ...
        private function _sendEmail($token,$type){
            ...
            $mail->addReplyTo('amad@gmail.com', 'ASK ME ABOUT DUBAI');
                ...
                if($type == 'verify'):
                    ...
                    $mail->Subject = 'ASK ME ABOUT DUBAI-ACCOUNT ACTIVATION';
                    $mail->isHTML(true);
                    ...
                    if(!$mail->send()):
                        $this->session->set_flashdata('message','<div class="alert alert-danger" role="alert">Your account activation has failed. '.$mail->ErrorInfo.'</div>');
                        redirect('admin/register');
                    else:
