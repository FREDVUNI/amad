...
<div class="page-breadcrumb">
   <div class="row">
      <div class="col-12 d-flex no-block align-items-center">
         <h4 class="page-title ml-3 text-secondary">Edit <?php echo $partner['partner'];?></h4>
   ...
   <div class="card-body">
      <div class="row">
         <div class="col-md-3 grid-margin stretch-card">
            <div class="card">
               <div class="card-body">
                  <?php echo form_open_multipart('admin/partner/'.$partner["slug"]);?>
                  <div class="d-flex flex-row">
                     <img src="<?php echo base_url('assets/backend/images/uploads/partners/').$partner['image'];?>" alt="partner" id="partnerImage" width="240"  height="250">
            ...
            <div class="card">
               <div class="card-body">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control <?php if(form_error('partner')): echo "is-invalid"; endif;?>" name="partner" id="partner" placeholder="Enter partner Name" value="<?php echo $partner['partner'] ?? set_value('partner');?>">
                     <span class="text-danger"><?php echo form_error('partner');?></span>
                  </div>
                  <div class="form-group">
                     <label>URL <span class="text-danger">*</span> </label>
                     <input type="text" class="form-control <?php if(form_error('url')): echo "is-invalid"; endif;?>" name="url" id="url" placeholder="Enter URL Name" value="<?php echo $partner['url'] ?? set_value('url');?>">
...
<script>
   ...
   function readURL(input) {
       ...
       reader.onload = function (e) {
           $('#partnerImage').attr('src', e.target.result);
           $('#imageerror').text('')
       };
     }
   }
   function DeleteImage() {
       $('#partnerImage').attr('src', '<?php echo base_url('assets/backend/images/uploads/partners/').$partner['image'];?>');
       $('#imageerror').text('')
