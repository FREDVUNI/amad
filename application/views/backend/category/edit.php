...
<div class="page-breadcrumb">
   <div class="row">
      <div class="col-12 d-flex no-block align-items-center">
         <h4 class="page-title ml-3 text-secondary">Edit <?php echo $category['category'];?></h4>
            ...
            <div class="card">
               <div class="card-body">
                  ...
                  <div class="d-flex flex-row">
                     <img src="<?php echo base_url('assets/backend/images/uploads/categories/').$category['image'];?>" alt="category" id="categoryImage" width="300"  height="250">
            ...
            <div class="card">
               <div class="card-body">
                  <div class="form-group">
                     ...
                     <input type="text" class="form-control <?php if(form_error('category')): echo "is-invalid"; endif;?>" name="category" id="category" placeholder="Enter Category Name" value="<?php echo $category['category'] ?? set_value('category');?>">
                  ...
                  <div class="form-group">
                     ...
                     <select name="icon" id="icon" class="form-control input-category <?php if(form_error('icon')): echo "is-invalid"; endif;?>" >
                        <option value="<?php  echo $category['icon'];?>">
                  ...
                  <div class="form-group">
                     ...
                     <textarea id="details" name="details" style="height: 250px; width:100%" class="form-control <?php if(form_error('details')): echo "is-invalid"; endif;?>"><?php echo $category['details'];?></textarea>
...
<script>
   ...
   function DeleteImage() {
       $('#categoryImage').attr('src', '<?php echo base_url('assets/backend/images/uploads/categories/').$category['image'];?>');
       $('#imageerror').text('')
